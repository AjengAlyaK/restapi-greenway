...
app.post('/discussion/:id/comment/up-votes', verifyToken, upVotesCommentOnDiscussion);
app.post('/discussion/:id/comment/down-votes', verifyToken, downVotesCommentOnDiscussion);
app.post('/discussion/:id/comment/netral-votes', verifyToken, netralVotesCommentOnDiscussion);
